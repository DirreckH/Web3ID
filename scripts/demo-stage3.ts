...
async function main() {
  ...
  spawnCommand("cmd", ["/c", "pnpm --filter @web3id/analyzer-service dev"], sharedEnv, "inherit");
  spawnCommand("cmd", ["/c", "pnpm --filter @web3id/policy-api dev"], sharedEnv, "inherit");
  ...
  console.log("Phase3 demo running");
