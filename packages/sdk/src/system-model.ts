  ...
  objects: [
    {
      ...
      stability: "stable",
      summary: "Immutable registry-backed single-controller anchor for the identity tree.",
      binding: {
        doc: "docs/SYSTEM_MODEL.md",
        code: ["packages/identity/src/index.ts", "packages/identity/src/controller-registry.ts", "packages/sdk/src/system-model.ts"],
        tests: ["packages/sdk/src/system-model.test.ts", "tests/system/core-acceptance.test.ts", "tests/system/tron-controller-acceptance.test.ts", "tests/system/mainstream-chains-full-acceptance.test.ts"],
